...
<?php if ($_SESSION['user']['is_admin'] ?? false): ?>
    ...
    <button id="sidebarToggle" class="mobile-only button-primary"> <i class="fa-solid fa-bars"></i> </button>
                    ...
                    <div class='stat-card'>
                        ...
                        <div class='stat-icon'>
                            <a href='/profile/{$username}' class='view-profile'>
                                <img src='{$profilePicture}' class='profile-pic-small' alt='Profile picture of {$username}'>
                            </a>
                        </div>
                        <div class='stat-info'>
