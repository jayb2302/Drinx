...
<div class="profile-header">
    ...
    <div class="profile-picture">
        ...
        <?php else: ?>
            <img src="<?= asset('uploads/profile_pictures/default.jpg'); ?>" alt="Default Profile Picture" class="profile-img">
        <?php endif; ?>
    </div>

    <!-- User Info -->
    <div class="profile-info">
        <h2><?= htmlspecialchars($profile->getFirstName()) . ' ' . htmlspecialchars($profile->getLastName()); ?></h2>
