...
if (isset($_COOKIE['logout_success'])) {
    echo '<div id="message" class="success"><h4> <i class="fa-solid fa-bell"></i><span>' . htmlspecialchars($_COOKIE['logout_success']) . '</span><i class="fa-solid fa-bell"></i></h4></div>';
...
if (isset($_COOKIE['account_deleted_success'])) {
    echo '<div id="message" class="success"><h4> <i class="fa-solid fa-bell"></i><span>' . htmlspecialchars($_COOKIE['account_deleted_success']) . '</span><i class="fa-solid fa-bell"></i></h4></div>';
            ...
            <div class="stickyContainer">
                <div class="stickyCard">
                    ...
                    <a href="/cocktails/<?= htmlspecialchars($stickyCocktail->getCocktailId()) ?>-<?= urlencode($stickyCocktail->getTitle()) ?>">
                        <h3 class="stickyTitle"><?= htmlspecialchars(ucwords(strtolower($stickyCocktail->getTitle()))); ?></h3> 
